...
import { UsineComponent } from 'app/entities/usine/usine.component';
import { UsineService } from 'app/entities/usine/usine.service';
import { Usine } from 'app/shared/model/usine.model';

describe('Component Tests', () => {
  describe('Usine Management Component', () => {
    let comp: UsineComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UsineComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.usines && comp.usines[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
public class EmployeeResourceIT {
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getDatedenaissance()).isEqualTo(DEFAULT_DATEDENAISSANCE);
    }
    ...
    public void checkDatedenaissanceIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeRepository.findAll().size();
        // set the field null
        employee.setDatedenaissance(null);
    ...
    public void updateEmployee() throws Exception {
        ...
        assertThat(testEmployee.getDatedenaissance()).isEqualTo(UPDATED_DATEDENAISSANCE);
    }
